...
class StudentController extends Controller
{
    ...
    public function index()
    {
        return view('students.data')->with([
            'students'=> Student::all() // jangan lupa  route list di terminal, ini ternyata route (student)
        ]);
    }
    ...
    public function store(StoreStudentRequest $request)
    {
        ...
        $students->idstudent = $request->txtid;
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Student $student, $idstudent)
    {
        echo $idstudent;
    }
